...
/**
 * Class ElasticsearchLogRepositoriesCompilerPass.
 */
class ElasticsearchLogRepositoriesCompilerPass extends TagCompilerPass
{
    /**
    ...
    {
        return 'apisearch_server.elastica_log_repository';
    }
